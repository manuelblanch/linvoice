...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<tr>
				<td width="60%" valign="top">
					...
					<p class="notop">						
						...
						<?php echo invoice_tax_id ($invoice); ?><br/>
                                                Phone: <?php echo invoice_from_phone_number ($invoice); ?><br/>
                                                Email: <?php echo invoice_from_email ($invoice); ?><br/>
                                                Sales Staff: <?php echo invoice_from_name($invoice); ?><br />
					</p>
				</td>
		...
		<p>
			...
			Phone: <?php echo invoice_to_phone_number($invoice); ?><br/>
		...
		<table style="width: 100%;">
			...
			<tr>
                ...
                <?php echo nl2br($invoice->invoice_custom_1) ?> 
                <hr size="1"/>
                <h4>Accepted by:</h4>
                <br/>
                <br/>
                <br/>
                <font size="1">(Signature and Co. Stamp)</font>
	</body>
</html>