...
<div class="grid_10" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<div class="content toggle">
			...
			<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" name="invoice_item_form" id="invoice_item_form" title="<?php echo $this->lang->line('tooltip_add_invoice_item'); ?>">

				<dl>
					<dt><label></label></dt>
					<dd>
						<select name="inventory_id" id="inventory_id" style="width: 250px;">
				...
				<dl>
					...
					<dd><input type="text" name="item_qty" id="item_qty" value="<?php echo format_qty(($this->mdl_items->form_value('item_qty') ? $this->mdl_items->form_value('item_qty') : 1)); ?>" /></dd>
				</dl>
                ...
                <dl>
                    ...
                    <dd><input type="checkbox" name="save_as_inventory" id="save_as_inventory" title="<?php echo $this->lang->line('tooltip_save_as_inventory'); ?>" value="1" <?php if ($this->input->post('save_as_inventory')) { ?>checked="checked"<?php } ?>/>&nbsp;<?php echo $this->lang->line('good_for_reuse'); ?></dd>
                </dl>
