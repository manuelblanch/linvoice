...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="container_10" id="center_wrapper">
                        <center><?php echo '<img src="' . base_url() . 'assets/style/img/logo.png" style="margin-top: 10px"/>'; ?></center>
			<div class="grid_5 push_2" id="content_wrapper">

				<div class="section_wrapper">

					<h3 class="title_black" align="center"><?php echo $this->lang->line('log_in'); ?></h3>                                    
