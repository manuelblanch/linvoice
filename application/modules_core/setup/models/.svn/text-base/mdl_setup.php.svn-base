...
class Mdl_Setup extends MY_Model {
    ...
    function db_tables() {
        ...
        return array(
            ...
            `item_name` longtext CHARACTER SET utf8,
            ...
            /*
             *  create database module Expenses
             */
            
            "CREATE TABLE `mcb_expense` (
                `mcb_expense_id` int(11) NOT NULL AUTO_INCREMENT,
                `mcb_expense_name` varchar(300) NOT NULL,
                `mcb_expense_category` int(11) NOT NULL,
                `mcb_expense_date`  date,
                `mcb_expense_amount` float,
                `mcb_expense_note` varchar(300) NOT NULL,
                `mcb_expense_client` int(11) NOT NULL,
                `mcb_expense_payto` varchar(300) NOT NULL,
                PRIMARY KEY (`mcb_expense_id`)
            ) ENGINE=MyISAM DEFAULT CHARSET=utf8;",
            
            "CREATE TABLE `mcb_expense_file` (
                `mcb_expense_file_id` int(11) NOT NULL AUTO_INCREMET,
                `mcb_expense_id` int(11) NOT NULL,
                `mcb_expense_file_title` varchar(300) NOT NULL,
                `mcb_expense_file_url` varchar(300) NOT NULL,
