	...
	<div class="section_wrapper">
		...
		<div class="content toggle">
			...
			<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>">
				...
				<dl>
					<dt><label><?php echo $this->lang->line('field_default_value'); ?>: </label></dt>
					<dd><textarea rows="5" cols="50" name="field_default_value" id="field_default_value"><?php echo $this->mdl_fields->form_value('field_default_value'); ?></textarea></dd>
				</dl>
