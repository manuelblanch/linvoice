...
$lang['good_for_reuse'] = '(Good for future reuse)';
...
$lang['tooltip_add_invoice_item'] = '<ul style=\'list-style: disc; text-align: left; margin-left: 10px;\'><li>Choose an existing item from the dropdown as a template.</li><li>Or key in a brand-new item (and save it as an inventory item for next time, if you want to)</li></ul>';
$lang['total'] = 'Total';
